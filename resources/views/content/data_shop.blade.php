<x-guest-layout>
    ...
    <div class="p-3">
        <p>Core data and non-core or worked-up data sets are freely available via the different routes as described
            below:</p>
        <div class="rounded-top grid grid-cols-3 gap-4">
            <div>
                <h2 class="bg-nw-blue-700 text-nw-blue-50 mt-4 h-8 content-center px-4 text-lg font-medium">
            ...
            <div>
                <h2 class="bg-nw-blue-700 text-nw-blue-50 mt-4 h-8 content-center px-4 text-lg font-medium">
                    <strong>3. Non-core and Worked-up Datasets</strong>
                </h2>
                <br>
                <p> A collection of non-core and worked-up datasets are available from the Rothamsted Data Repository.
                    <br><br>
                    Note that the <a
                        class="text-nw-blue-700 px-0 visited:text-amber-900 hover:text-orange-700 active:text-orange-900"
                        class="text-blue-500 hover:underline" href="{{ route('publications') }}">Publications page</a>
                    also contains sources of data under the Dataset category.
                </p>
            </div>
        </div>
        <div class="rounded-top grid grid-cols-3 gap-4">
            ...
            <div  class="mt-4">
                <x-button-link
                    href="https://api-nwfp.rothamsted.ac.uk/"
                    target="_blank">
                    Click to Access API
                </x-button-link>
            </div>
            <div  class="mt-4">
                <x-button-link
                    href="https://repository.rothamsted.ac.uk/cgi/tabbed_search/archive/advanced?refereed=EITHER&dataset=archive&screen=Material%3A%3ATabbedSearch&keywords=NWFP%20data"
                    target="_blank">
    ...
    <h2 class="bg-nw-blue-700 text-nw-blue-50 mt-10 h-8 content-center px-4 text-lg font-medium">Aknowledgment</h2>
    <div class="p-3">
        ...
        <ul class="space-y-3 p-3">
            ...
            <ul class="space-y-3">
                <x-li-arrow>
                    ...
                    J.A.J. Dungait, K.W.T.Goulding, B.A. Griffith, S.J. Gurr, P. Harris, J.M.B. Hawkins, T.H.
                    Misselbrook,
                    C. Rawlings, A. Shepherd, H. Sint, T. Takahashi, K.N. Tozer, A.P. Whitmore, L. Wu and M.R.F. Lee.
                    (2016). The North Wyke
                ...
                <x-li-arrow>
                    ...
                    J. M. B. Hawkins, T. H. Misselbrook, G. A. McAuliffe, J. N. McFadzean, P. J. Murray, R. J. Orr, M.
                    J.
                    Rivero, L. Wu, M. R. F. Lee, 2018. Roles of instrumented farm-scale trials in trade-off assessments
                    of
            ...
            <x-li-dot class="bg-nw-blue-500">
                <p class="font-semibold">3. For the datasets used, please cite the latest version of the relevant User
                    Guide PDF document(s),
                    that describe the establishment and development of the NWFP, and the various datasets produced in
                    detail.
                    These are listed on the <a
                        class="text-nw-blue-700 px-0 visited:text-amber-900 hover:text-orange-700 active:text-orange-900"
                        href="{{ route('nw-guides') }}"><span class="font-semibold">Data User Guides</span></a>
                    webpage.<br>
                    Note that the User Guide entitled "NWFP_UG_Design_Develop.pdf" should be cited irrespective of the
                    dataset used.
                </p>
            </x-li-dot>
            ...
            <div class="border-2 border-red-700 bg-red-50 p-2">
                <p>The North Wyke Farm Platform is a National Bioscience Research Infrastructure (NBRI) supported by the
                    Biotechnology and
